...
This project develops a machine learning model to predict the likelihood of Mental Health Status in patients based on medical attributes such as Statement & Status [Mental Detector App]()

🎯 **OBJECTIVE**
- Performended Text Tokenization, Data Balancing & Encoding.

- Perform data cleaning and preprocessing on the Mental Health Sentiment Dataset.
...
📂**DATASET:** 😣💊 Mental Health Data Report
